<html>
    ...
    <body>
        ...
        <main>
            <h1 clfss="zagalofak">Професіонали радять</h1>
            <section class="info">
                <article class="post">
                ...
                <article class="post">
                    ...
                    <img class="imgg" src="https://learn.logikaschool.com/uploads/2021/03/tag-151102.svg" />
                    <p class="post-text">І цілого світу мало...</p>
                    <a class="article-but" href="">Докладніше</a>
                </article>
            </section>
            <aside class="asid">
            <p><b>Напиши –<br> отримай<br> промокод!</b></p>
        ...
        <footer>
            <div class="contacts">
                ...
                <img class="thumds up" src="https://img1.freepng.ru/20180704/kwh/kisspng-thumb-signal-green-clip-art-thumbs-up-down-5b3d530e617b72.9608269015307456143993.jpg" width="50px" height="50px" />
            </div>
